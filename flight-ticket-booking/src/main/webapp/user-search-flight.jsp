...
<body>
  ...
  AdminAddFlightDao adminAddFlightDao= new AdminAddFlightDao();
  
  List<AdminAddFlight> addFlights=adminAddFlightDao.getFlightBySourceToDestination(source, destination);
...
%>
  ...
  %>
			...
			<tr class="table-row">
				...
				<td><a
					href="user-book-flight.jsp?flightNumber=<%=addFlight.getFlightNumber()%>"
					class="update">Book</a></td>
			</tr>
